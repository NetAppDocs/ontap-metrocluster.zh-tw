...
image::../media/mcc_dr_groups_8_node.gif[MetroCluster DR 組 8 節點]

下圖顯示了四節點MetroCluster 的節點的架構。

image::../media/mcc_dr_groups_4_node.gif[MetroCluster DR 群組四個節點]
...
image::../media/mcc_hardware_architecture_both_clusters.gif[兩個叢集的四節點結構MetroCluster配置]

下圖顯示單MetroCluster 一支援叢集中連線能力的更詳細檢視（兩個叢集的組態相同）：

image::../media/mcc_hardware_architecture_cluster_a_with_7500n.gif[MetroCluster集群 A 與 FibreBridge 7500N 橋接器的連接]
...
image::../media/mcc_hardware_architecture_both_clusters_2_node_fabric.gif[雙節點結構MetroCluster配置兩個集群]
...
image::../media/mcc_hardware_architecture_cluster_a_2_node_with_7500n.gif[雙節點MetroCluster叢集 A 與 FibreBridge 7500N 橋接器的連接]
