...
image::../media/workflow_high_level_node_and_cluster_configuration_software.gif[ONTAP中的工作流程進階節點和叢集配置]
...
.相關資訊
link:https://docs.netapp.com/us-en/ontap/high-availability/index.html["HA配對管理"^]
