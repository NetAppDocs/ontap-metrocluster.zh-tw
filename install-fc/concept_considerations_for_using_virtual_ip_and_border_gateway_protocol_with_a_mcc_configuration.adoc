...
---
= MetroCluster FC 組態中的虛擬 IP 和 BGP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/vip_and_bgp_in_metrocluster_2.png[MetroCluster中的虛擬 IP 和邊界網關協議]
...
設定完成後、V0a（v0b等）會持續驗證連線能力、以確保LIF移轉或容錯移轉成功（不像L2、只有在停機後才能看到毀損的組態）。
