...
如需使用FabricPools的一般資訊、請參閱 https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-psmg/home.html["磁碟與集合體管理"^]
...
從ONTAP 功能完善的9.11.1開始、MetroCluster 在功能完善的組態中、兩個叢集都能成為SVM DR與第三個站台之間關係的來源。
