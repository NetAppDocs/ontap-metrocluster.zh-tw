...
---
= 在 Fabric 附加的 MetroCluster FC 組態中不中斷營運地更換機櫃
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/mcc_shelf_replacement_bridges_with_a_single_stack.gif[單層貨架更換橋]
...
+
image::../media/mcc_shelf_replacement_bridges_with_four_stacks.gif[帶有四個堆疊的貨架更換橋]
