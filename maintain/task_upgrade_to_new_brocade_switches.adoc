...
---
= 在 MetroCluster FC 組態中升級至新的 Brocade FC 交換器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/brocade_upgr_to_g620_replacement_completed.gif[完成後Brocade升級至G620]
...
----
+
image::../media/brocade_upgr_to_g620_fab_1_down.gif[Brocade升級至 G620，Fabric 1 被取消]
...
.. 在機架中安裝新的交換器。
+
image::../media/brocade_upgr_to_g620_replaced_a_1.gif[Brocade升級至 G620 並更換 A1]
...
+
image::../media/brocade_upgr_to_g620_replaced_b_1.gif[Brocade升級至 G620 並更換 B1]
...
image::../media/brocade_upgr_to_g620_replacement_completed.gif[Brocade G620 交換器更換與升級完成後的MetroCluster工作流程]
