...
---
= 為延伸式 MetroCluster 組態安裝 FC 轉 SAS 橋接器與 SAS 磁碟櫃
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/workflow_bridge_installation_and_configuration.gif[FC 至 SAS 橋接器安裝和配置的工作流程]
...
image::../media/mcc_cabling_bridge_and_sas3_stack_with_7500n_and_multiple_stacks.gif[MetroCluster佈線 FibreBridge 配置與多個 SAS3 堆疊]
