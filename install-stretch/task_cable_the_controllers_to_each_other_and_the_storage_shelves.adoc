...
. 連接FC-VI連接埠。
+
image::../media/mcc_cabling_fc_vi_controller_to_partner.gif[MetroCluster將 FC VI 控制器連接到合作夥伴]
...
+
image::../media/mcc_two_node_optical_sas_space_configuration.png[雙節點光纖 SAS 配置]
