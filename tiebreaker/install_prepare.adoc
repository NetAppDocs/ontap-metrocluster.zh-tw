...
.接下來呢？
* 如果您正在安裝或升級至 Tiebreaker 1.5 或更高版本，link:install_security.html["確保 MetroCluster Tiebreaker 主機和資料庫安裝安全"]。
* 如果您正在安裝或升級到 Tiebreaker 1.4，link:install-dependencies-14.html["安裝 MetroCluster Tiebreaker 1.4 相依性"]。
