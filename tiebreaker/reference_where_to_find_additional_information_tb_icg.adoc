...
---
= 哪裡可以找到有關 MetroCluster Tiebreaker 的更多資訊
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 所有MetroCluster 資訊
 ...
 a| 
https://www.netapp.com/pdf.html?item=/media/13482-tr4375.pdf["NetApp技術報告4375：NetApp MetroCluster 的《ONTAP 關於NetApp的資訊》9.3"^]
 a| 
