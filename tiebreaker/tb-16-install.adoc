...
---
= 安裝 MetroCluster Tiebreaker 1.6 或 1.6P1
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在主機 Linux 作業系統上執行新的安裝或升級至 tiebreaker 1.6 或 tiebreaker 1.6P1 、以監控 MetroCluster 組態。
...
NOTE: 安裝 Tiebreaker 1.6 或更高版本後，您需要 link:concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["匯入憑證"] 啟用無縫監控。



[[install-or-upgrade-to-tiebreaker-1-6p1]]
== 安裝或升級至 tiebreaker 1.6P1

您可以安裝斷路器 1.6P1 、或從斷路器 1.6 、 1.5 或 1.4 升級至斷路器 1.6P1 。

.步驟
. 下載 MetroCluster tiebreaker 1.6P1 軟體。
+
...
. 以root使用者身分登入主機。
. 如果您正在執行升級、請確認您正在執行的 tiebreaker 版本：
+
以下範例顯示 tiebreaker 1.5 。
...
.將 1.6 升級至 1.6P1
--
請依照下列步驟、將 tiebreaker 1.6 軟體版本升級為 tiebreaker 1.6P1 。


NOTE: 從 1.6 升級至 tiebreaker 1.6P1 之後、您可以移除現有的顯示器、然後重新新增 MetroCluster 組態以進行監控。
...
----
=====
.. 按照中的步驟刪除並重新添加 MetroCluster 配置link:concept_configuring_the_tiebreaker_software.html["設定Tiebreaker軟體"]。


--
.將 1.5 升級至 1.6P1
--
請依照下列步驟、將 tiebreaker 1.5 軟體版本升級為 tiebreaker 1.6P1 。
...
.將 1.4 升級至 1.6P1
--
請依照下列步驟、將 Tiebreaker 1.4 軟體版本升級至 tiebreaker 1.6P1 。
...
== 安裝或升級至 tiebreaker 1.6

您可以安裝斷路器 1.6 或從 tiebreaker 1.5 或 1.4 升級至 tiebreaker 1.6 。

.步驟
. 下載 MetroCluster Tiebreaker 1.6 軟體。
+
https://mysupport.netapp.com/site/products/all/details/metrocluster-tiebreaker/downloads-tab["MetroCluster Tiebreaker （下載） - NetApp 支援網站"^]
...
.從 1.5 升級到 1.6
--
請依照下列步驟、將 tiebreaker 1.5 軟體版本升級至 tiebreaker 1.6 。
...
.將 1.4 升級至 1.6
--
請依照下列步驟、將 Tiebreaker 1.4 軟體版本升級至 Tiebreaker 1.6 。
...
.接下來呢？
成功安裝或升級 Tiebreaker 後，link:configure-tb-workflow.html["設定 MetroCluster Tiebreaker 軟體"] 以新增 MetroCluster 組態並匯入所需的憑證。
