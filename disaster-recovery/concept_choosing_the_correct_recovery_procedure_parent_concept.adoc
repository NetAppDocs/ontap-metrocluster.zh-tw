...
+
image::../media/mcc_dr_groups_8_node_with_a_single_controller_failure.gif[具有單一控制器故障的八節點MetroCluster DR 群組]
...
image::../media/mcc_dr_groups_8_node_with_a_multi_controller_failure.gif[具有多個控制器故障的八節點MetroCluster DR 群組]
...
image::../media/mcc_dr_groups_8_node_with_two_single_controller_failures.gif[八節點MetroCluster DR 組，其中兩個單控制器發生故障]
...
image::../media/mcc_dr_groups_8_node_with_a_3_controller_failure.gif[八節點MetroCluster DR 組，其中三個控制器發生故障]
...
image::../media/mcc_dr_groups_2_node_with_a_single_controller_failure.gif[具有單一控制器故障的雙節點MetroCluster DR 群組]
