...
image::../media/four_node_transition_mcc_9151.png[顯示 IP 轉 FC 轉換支援的平台組合]

* 附註 1 ：此平台組合需要 ONTAP 9.13.1 或更新版本。
* 附註 2 ： FC 節點上的本機叢集介面必須有 100GbE 介面。此平台組合需要 ONTAP 9.11.1 或更新版本。
