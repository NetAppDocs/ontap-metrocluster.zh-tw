...
---
= 準備進行中斷營運的 MetroCluster FC 到 IP 轉換
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/transition_2n_4_new_ip_nodes_on_the_shelves.png[在現有機架上使用四個新 IP 節點進行過渡]
...
image::../media/workflow_2n_transition_bsaic.png[雙節點過渡的工作流程]
