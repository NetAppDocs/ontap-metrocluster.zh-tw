...
---
= 當新控制器不支援 MetroCluster 機櫃時，中斷營運地轉移
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image::../media/workflow_2n_transition_old_shelves_not_supported.png[舊貨架不受支援時的過渡工作流程]
...
image::../media/transition_2n_unsupported_old_new_shelves_to_old_controllers.png[過渡期間將新機架佈線到舊控制器]
