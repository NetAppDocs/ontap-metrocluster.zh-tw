...
image:../media/tech-refresh-ip-group-1-updated.png["AFF和FAS第 1 組平台的系統刷新組合"]
...
image:../media/tech-refresh-ip-group-2-updated.png["AFF和FAS第 2 組平台的系統刷新組合"]
...
image::../media/metrocluster_fc_tech_refresh.png[MetroCluster FC 技術更新支援的平台組合]
