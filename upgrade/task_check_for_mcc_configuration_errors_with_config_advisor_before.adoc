---
permalink: upgrade/task_check_for_mcc_configuration_errors_with_config_advisor_before.html 
sidebar: sidebar 
...
---
= 在 MetroCluster FC 擴充之前，請使用 Config Advisor 檢查 MetroCluster 組態錯誤
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
