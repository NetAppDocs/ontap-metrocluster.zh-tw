...
從 ONTAP 9.13.1 開始、您可以暫時擴充八節點 MetroCluster 組態、以重新整理控制器和儲存設備。請參閱 link:https://docs.netapp.com/us-en/ontap-metrocluster/upgrade/task_refresh_4n_mcc_ip.html["重新整理四節點或八節點 MetroCluster IP 組態（ ONTAP 9.8 及更新版本）"] 以取得更多資訊。
...
====
image::../media/8node_comb_ip_914.png[8 個節點組態的平台組合]
