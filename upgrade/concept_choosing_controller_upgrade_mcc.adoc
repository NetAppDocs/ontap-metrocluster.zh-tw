...
image::../media/metrocluster_ip_upgrade_table_yellowdogdp1.PNG[MetroCluster IP 升級表黃頁 dp1]
...
image::../media/metrocluster_fc_upgrade_table_yellowdogp1.PNG[MetroCluster 光纖通道升級表黃頁 1]
