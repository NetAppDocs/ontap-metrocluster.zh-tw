...
+
link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#remove-metrocluster-configurations["移除MetroCluster 不完整的組態"]
...
image::../media/mcc_upgrade_cluster_a_in_switchover.png[MetroCluster切換後，Site_B 處於非活動狀態並準備升級]
...
. 如果使用根磁碟區加密，根據您使用的 ONTAP 版本，選擇開機功能表選項或再次發出開機功能表命令以進行金鑰管理組態。
+
[role="tabbed-block"]
====
.更新版本ONTAP
...
image::../media/mcc_upgrade_cluster_a_switchback.png[MetroCluster切換後，Site_A 等待升級]
