...
NOTE: 如果原始或新平台是使用連接埠1c和1d的FAS8020或AFF8020系統、請參閱 link:https://kb.netapp.com/Advice_and_Troubleshooting/Data_Protection_and_Security/MetroCluster/Upgrading_controllers_when_FCVI_connections_on_existing_FAS8020_or_AFF8020_nodes_use_ports_1c_and_1d["NetApp知識庫：在現有FAS8020或AFF8020節點上使用連接埠1c和1d的FCVI連線時、升級控制器。"^]

* 兩個站台的授權必須相符。您可以從取得新的授權 link:https://mysupport.netapp.com/site/["NetApp 支援網站"^]。
* 此程序適用於MetroCluster 採用支援以支援功能支援功能的控制器模組（雙節點Stretch MetroCluster 、雙節點或雙節點或四節點Fabric附加MetroCluster 功能的支援功能）。
...
NOTE: 在FC-VI模式中使用1c和1d連接埠時、不支援升級FAS8020或AFF8020。
