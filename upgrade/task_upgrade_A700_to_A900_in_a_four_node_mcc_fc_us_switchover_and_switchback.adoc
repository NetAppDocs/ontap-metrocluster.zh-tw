...
. 請依照以下步驟操作： link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#add-metrocluster-configurations["新增MetroCluster 功能"] 在_MetroCluster Tiebreaker 安裝和配置_部分。
