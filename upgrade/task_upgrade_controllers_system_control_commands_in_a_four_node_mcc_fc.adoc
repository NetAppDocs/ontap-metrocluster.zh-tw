...
* 只有執行版本9.9.1之前的系統、才支援使用內建連接埠0e和0f作為FC-VI連線的AFF 從EVA300或FAS8200平台升級ONTAP 。如需詳細資訊、請參閱 link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/BURT/1507088["公開報告"]。
