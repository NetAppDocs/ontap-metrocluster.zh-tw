...
---
= 使用系統控制器替換支援的 MetroCluster IP 控制器升級
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 註 3：整合系統（磁碟和控制器在同一機箱內）的升級需要更換控制器模組，同時保留現有的機箱和磁碟。
* 註 4：需要 IOM 模組才能將舊控制器轉換為外部 SAS 機架。請參閱 link:https://hwu.netapp.com/["Hardware Universe"^] 以了解支援的 IOM 模組。
* 註 5：需要 ONTAP 9.18.1GA 或更高版本。
...
image:../media/assisted-group-2-a70-a90-updated.png["顯示 AFF 和 FAS 升級組合組 2"]
