...
* 從ONTAP 9.18.1 和ONTAP Mediator 1.11 開始，單一ONTAP Mediator 實例可以同時管理多達 10 個MetroCluster配置。在早期版本中， ONTAP Mediator 可以同時支援最多五個MetroCluster配置。
...
NOTE: 系統會提示您輸入 Mediator 管理員使用者帳號的使用者名稱和密碼。
