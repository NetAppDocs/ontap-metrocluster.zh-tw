...
* 使用單一 ONTAP Mediator 執行個體監控多個 MetroCluster IP 組態的支援取決於您設定 ONTAP Mediator 時使用的是 HTTPS 還是 iSCSI。如需詳細資訊、請參閱 link:concept_mediator_requirements.html#mediator-multiple-mccip["使用 ONTAP Mediator 監控多個 MetroCluster IP 組態"]。
