...
如果您需要以網路開機新的控制器、請參閱 link:../upgrade/task_upgrade_controllers_in_a_four_node_ip_mcc_us_switchover_and_switchback_mcc_ip.html#netboot-the-new-controllers["以網路開機新的控制器模組"]。
