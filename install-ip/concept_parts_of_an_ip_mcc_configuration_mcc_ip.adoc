...
image::../media/mcc_ip_hardware_architecture_mcc_ip.gif[MetroCluster IP 硬體架構]
...
image::../media/mcc_ip_hardware_architecture_ha_pairs.gif[MetroCluster IP 硬體架構 HA 對]
...
image::../media/mcc_ip_hardware_architecture_ip_interconnect.png[MetroCluster IP 硬體架構 IP 互連]
...
image::../media/mcc_ip_lif_usage.gif[MetroCluster IP LIF 使用情況]
...
image::../media/mcc_ip_hardware_architecture_cluster_peering_network.gif[MetroCluster IP 硬體架構叢集對等網路]
