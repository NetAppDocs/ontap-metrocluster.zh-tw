...
image::../media/mcc_ip_networking_with_shared_isls.gif[具有共享 ISL 的MetroCluster IP 網路範例]
...
image::../media/mcc_ip_networking_with_intermediate_private_networks.gif[具有中間專用網路的MetroCluster IP 網路範例]
...
image::../media/mcc_ip_two_mccs_sharing_the_same_shared_network_sx.gif[MetroCluster IP 佈線，兩個配置共享同一個中間網絡]
...
image::../media/mcc_ip_unsupported_two_mccs_direct_to_shared_switches.png[兩個 MetroCluster 直接透過電纜連接到共享交換器的不支援的設定範例]
