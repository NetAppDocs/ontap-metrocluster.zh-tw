...
檢閱平台連接埠指派，將 AFF A20 系統連接至 Cisco 3232C 或 9336C 交換器：image:../media/mcc-ip-cabling-aff-a20-9161.png["顯示 Cisco 3232C 或 Cisco 9336C 平台連接埠指派"]
...
image:../media/mcc-ip-cabling-a90-fas90-c80-fas70-a70-a1k-cisco-3232C-or-9336c-switch.png["顯示 Cisco 3232C 或 Cisco 9336C 平台連接埠指派"]
