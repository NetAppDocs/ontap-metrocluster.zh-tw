...
---
= 設定 SNMPv3 來監控MetroCluster IP 交換器的運作狀況
:allow-uri-read: 
...
.Cisco交換器
--
在 Cisco Nexus 交換器上設定 SNMPv3 使用者名稱 SNMPv3_USER：
...
.NVIDIA-CL 5.4.0
--
在執行 CL 5.4.0 的 NVIDIA Cumulus 交換器上設定 SNMPv3 使用者名稱 SNMPv3_USER：
...
.NVIDIA - CL 5.11.0+
--
在執行 CLI 5.11.0 及更高版本的 NVIDIA Cumulus 交換器上設定 SNMPv3 使用者名稱 SNMPv3_USER：
