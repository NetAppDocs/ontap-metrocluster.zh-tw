...
image::../media/mcc_hw_architecture_local_ha.gif[MetroCluster配置中的本地 HA]
...
image::../media/mcc_mirroring_of_svms.gif[SVM 的MetroCluster鏡像]

如果發生切換、則存續叢集上的遠端叢集會上線、而次要SVM會開始提供資料。

image::../media/mcc_svms_after_switchover.gif[切換後的MetroCluster SVM]
...
image::../media/mcc_mirroring_of_pools.gif[MetroCluster儲存池鏡像]
...
| 以功能為設計目標MetroCluster | 在非MetroCluster HA配對中 
 ...
 a| 
image:../media/mcc_nvram_quartering.gif["MetroCluster配置中的非揮發性緩存四分之一"]
 a| 
image:../media/mcc_nvram_split_in_non_mcc_ha_pair.gif["非MetroCluster HA 對中的非揮發性快取拆分"]
...
image::../media/mcc_nvram_mirroring_example.gif[MetroCluster NVRAM鏡像範例]
...
image::../media/mcc_nvram_mirroring_example_dynamic_dr_aux.gif[具有 DR 輔助功能的MetroCluster NVRAM映像]
...
image::../media/mcc_disk_ownership.gif[MetroCluster磁碟所有權]
...
image::../media/mcc_so_sb_with_autoheal.gif[MetroCluster切換並切換回自動修復]
...
image::../media/mcc_uso_with_autoheal.gif[MetroCluster具有自動修復功能的計劃外切換]
